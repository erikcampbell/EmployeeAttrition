"""
Data Translation Challenge-Base Model-Unbalanced + All Variables
Erik C
"""
...
# Current/Past Employees density estimation for numerical values and target - Attrition
...
plt.ylabel('Density')
plt.title('Age Distribution in Percent by Employment Status, All- Range = 18-60, mean =36.9 and standard deviation = 9.1')
plt.legend()
