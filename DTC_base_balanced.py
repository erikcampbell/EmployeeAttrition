...
# Balanced Data - Undersampling class=Attrition feature
...
# Randomly select "X" current employees for balance
attrition_No_df = shuffled_data.loc[shuffled_data['Attrition'] == 'No'].sample(n=237)
...
# Categorical variables given dummies, if applicable
